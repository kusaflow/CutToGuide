...
public class resetGame implements Screen {
    ...
    public resetGame(MainGame game){
        this.game = game;
    ...
    public void render(float delta) {
        Gdx.gl.glClearColor(0.9f, 0.3f, .3f, 1f);
        ...
        font.draw(AllVariables.batch, "Sure you want to delete saved data" ,280, 500);
