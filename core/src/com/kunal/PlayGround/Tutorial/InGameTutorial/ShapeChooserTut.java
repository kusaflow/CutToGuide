...
public class ShapeChooserTut implements Screen {
    ...
    private void input(float dt){
        ...
        if (Gdx.input.justTouched()) {
            ...
            if (Gdx.input.getX() > (40 * AllVariables.inpM)+AllVariables.witdth_translation && Gdx.input.getX() < (260* AllVariables.inpM)+AllVariables.witdth_translation) {
                ...
                //reCut
                if ((Gdx.graphics.getHeight() - Gdx.input.getY()) > (101*AllVariables.inpM)
                        && (Gdx.graphics.getHeight() - Gdx.input.getY()) < 304* AllVariables.inpM
